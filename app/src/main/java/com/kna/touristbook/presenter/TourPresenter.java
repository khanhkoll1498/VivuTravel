...
import com.kna.touristbook.utils.DataChatBot;
...
//            }
//        }
        if (msg.equals("hoi_gia")) {
            mCallback.onReply("Giá của " + tour.getTitle() + "là " + tour.getPrice());
        } else if (msg.equals("hoi_tour")) {
            mCallback.onReply(tour.getDescription());
        } else {
            mCallback.onReply(DataChatBot.getInstance().getData(msg));
        }
    }
